...
class Timelapse:
    def __init__(self, enabled: bool, manual: bool, height: float, klippy: Klippy, camera: Camera, interval: int, logging_handler: logging.Handler = None, debug_logging: bool = False):
